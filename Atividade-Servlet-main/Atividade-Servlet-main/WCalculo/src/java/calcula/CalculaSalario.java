...
public class CalculaSalario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<h1>FGTS: " + obj_calculo.calculoFGTS() + "</h1>");
            out.println("<h1>INSS: " + obj_calculo.calculoINSS() + "</h1>");
            out.println("<h1>Imposto de Renda: " + obj_calculo.calculoIR() + "</h1>");
            out.println("<h1>Salário Líquido: " + obj_calculo.calculoSalarioLiquido() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
